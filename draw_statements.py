...
def draw_sql(table1, table2, table3, table1alias, table2alias, table3alias,
    ...
    font_manager.fontManager.addfont('/Users/gatter/Library/Fonts/SourceCodePro-Regular.otf')   # SQL font used by PgAdmin
    mpl.rcParams['font.family'] = "Source Code Pro"                                             # SQL font used by PgAdmin
    ...
    if pattern in (1, 2):
        ...
        ax.text(xdelta*8, -5*ydelta, '{}.{} = {}.{}'.format(table2alias, attribute22, table1alias, attribute12))
        ...
        ax.text(xdelta*10, -9*ydelta, '{}.{} = {}.{}))'.format(table3alias, attribute31, table2alias, attribute21))
    ...
    if pattern in (3, 4):
        ...
        ax.text(xdelta*10, -8*ydelta, '{}.{} = {}.{}'.format(table2alias, attribute21, table3alias, attribute31))
        ax.text(xdelta*4, -9*ydelta, 'AND', color='#990088')
        ax.text(xdelta*8, -9*ydelta, '{}.{} = {}.{}))'.format(table2alias, attribute22, table1alias, attribute12))
